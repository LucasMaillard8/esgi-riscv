...
#	load word veut dire qu'on affecte la valeur word (entier) à une adresse voulue
# - lw: What is the immediate use in front of the register containing the address?
#	cette valeur est additionnée à l'adresse pour se décaler de valeurs en valeurs
# - What will lw's destination register contain?
#	il contiendra la valeur de l'adresse indiquée
# - With an instruction like `add` what do the three registers correspond to?
#	le premier est la destination du resultat, les deux autres sont additionnés
# `add reg0, reg1, reg2`
# - reg0: la destination
# - reg1: première variable à additionner
# - reg2: deuxième variable à additionner
#
# - `la` what is it for?
#	laod une adresse dans la valeur du registre choisi
