...
#	d'après le tableau de droite, num0: 0x10010000, num1: 0x10010004, result: 0x10010008
# - What's the last code address of your program?
#	0x00400030 est l'adresse du ecall
...
# - When you access the memory by 32-bit words, what's the step?
	#la pour load une adresse puis lw pour affecter à cette adresse
